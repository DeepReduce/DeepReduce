...
if __name__ == '__main__':
    ...
    #
    # model_guanfang = keras.applications.resnet50.ResNet50(weights='imagenet')
    # preds_guanfang = model_guanfang.predict(x)  # (1.1000)
    # result_guanfang = decode_predictions(preds_guanfang)
    # print('Predicted:', result_guanfang)
    #
    # # print(result[0][0])  # ('n04592741', 'wing', 0.54972386)
    # # print(type(result[0][0]))  # tuple
    # # result[0]和result一样，都是list
# ---------------------------------------------------------------------------------------------------------
    # Load data

    x_val = np.load("data/x_val.npy") # loaded as RGB
    x_val = preprocess_input(x_val) # converted to BGR
    print('Input image shape:', x_val.shape)
