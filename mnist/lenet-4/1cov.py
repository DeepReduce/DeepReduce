...
path = 'doubleneuronnumber-lenet-4/'+str(changelayer)+'/'
...
if os.path.exists(path+'Cov/activeneuron/'+str(threshold)+'ase/') == False:
    os.makedirs(path+'Cov/activeneuron/'+str(threshold)+'ase/')

f = open(path+'Cov/activeneuron/'+str(threshold)+'ase/neuron_cov','w')
...
n = open(path+'Cov/activeneuron/'+str(threshold)+'ase/neuron','w')
