...
if __name__ == '__main__':
    ...
    if os.path.exists(os.getcwd() + '/' + changetype + 'layer-lenet-1/' + str(changeindex) + '/') == False:
        os.makedirs(os.getcwd() + '/' + changetype + 'layer-lenet-1/' + str(changeindex) + '/')

    # save model
    model.save(changetype + 'layer-lenet-1/' + str(changeindex) + '/lenet-1.h5')
