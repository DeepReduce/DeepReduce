...
def build_model():
    ...
    if changeindex == 5 and changetype == 'del':
        ...
        model.add(Dense(120, activation='relu'))
    # ------------------------------------------------------
    if changeindex == 6 and changetype == 'add':
        model.add(Dense(84, activation='relu'))

    if changeindex == 6 and changetype == 'del':
        pass
    else:
        model.add(Dense(84, activation='relu'))
    # ------------------------------------------------------
...
if __name__ == '__main__':
    ...
    if os.path.exists(os.getcwd() + '/' + changetype + 'layer-lenet-5/' + str(changeindex) + '/') == False:
        os.makedirs(os.getcwd() + '/' + changetype + 'layer-lenet-5/' + str(changeindex) + '/')

    # save model
    model.save(changetype + 'layer-lenet-5/' + str(changeindex) + '/lenet-5.h5')
