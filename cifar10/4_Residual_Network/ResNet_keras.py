...
def residual_network(img_input,classes_num=10,stack_n=5):
    ...
    x = Dense(classes_num,kernel_initializer="he_normal",
              kernel_regularizer=regularizers.l2(weight_decay))(x)
...
if __name__ == '__main__':
    ...
    # set callback
    cbks = [TensorBoard(log_dir='./resnet_{:d}_{}_new/'.format(layers,args.dataset), histogram_freq=0),
    ...
    resnet.save('resnet_{:d}_{}_new.h5'.format(layers,args.dataset))
